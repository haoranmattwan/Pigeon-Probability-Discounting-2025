...
# Add the mean data back to the main dataframe
combined_data <- bind_rows(combined_data, mean_data) |>
  mutate(
    # Re-order factor levels to place "Mean" at the end
    Subject = factor(Subject, levels = c("P41","P42","P43","P44","P45","P46","P47","P48","Mean"))
  )
